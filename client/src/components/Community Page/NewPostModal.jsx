    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/35 backdrop-blur-md transition-opacity" onClick={onClose}>
      ...
      >
        <div className="px-6 py-4 border-b border-gray-100/70 dark:border-white/[0.08] flex items-center justify-between bg-white/35 dark:bg-white/[0.03]">
           ...
           <button 
               className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/10 p-2 rounded-full transition-colors focus:outline-none" 
               onClick={onClose}
           >
              <X size={20} />
           </button>
          ...
          <form id="new-post-form" onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5 focus-within:text-emerald-600">
              ...
              <div className="relative">
                  ...
                  >
                      <option value="discussion" className="bg-white text-gray-900 dark:bg-[#1a1a1a] dark:text-gray-100">Discussion</option>
                      <option value="blog" className="bg-white text-gray-900 dark:bg-[#1a1a1a] dark:text-gray-100">Blog</option>
                      <option value="help" className="bg-white text-gray-900 dark:bg-[#1a1a1a] dark:text-gray-100">Help</option>
                  </select>
        ...
        <div className="px-6 py-4 border-t border-gray-100/70 dark:border-white/[0.08] bg-white/30 dark:bg-white/[0.03] flex justify-end gap-3 rounded-b-2xl mt-auto">
          <button 
             type="button" 
             className="px-5 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white/65 dark:bg-white/[0.03] border border-gray-300/80 dark:border-white/[0.12] rounded-lg hover:bg-white dark:hover:bg-white/10 focus:outline-none transition-colors backdrop-blur-sm" 
             onClick={onClose}
          >
            Cancel
          </button>
